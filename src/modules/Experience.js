        ...
        <table>
          <tr>
            ...
            <td>
              ...
              <p><span>Development of an <Link href="{$rootpath}/product/erp">Enterprise Resource Planning (ERP) System</Link> for Translation Automation using .NET C# and MSSQL</span></p>
              <p>
                ...
                <Link href="{$rootpath}/product/msword">Office Programming</Link>. 
					Develop fully owned NLP algorithms for sentence splitting, Chinese word segmentation, and phrase chunking, tailored 
					for bilingual text.
              </p>
              <p><span>Development of a <Link href="{$rootpath}/product/scidict">Bilingual Dictionary</Link> using .NET Web</span></p>
              <p>
              ...
              <p><span>Development of a <Link href="{$rootpath}/product/workbench">Computer-Aided Translation Workbench</Link> using .NET C#</span></p>
              <p>
