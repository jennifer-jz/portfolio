          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <ul>
                  <li>Collaborated with PM, Design, and Backend teams to implement complex user interfaces, new features, and enhancements for Medallia's Experience Cloud platform.</li>
                  <li>Led cross-team initiatives by clarifying requirements, conducting feasibility analyses, and resolving root causes to ensure timely and successful delivery of tickets.</li>
                  <li>Delivered high-quality product features that align with design standards, ensuring responsiveness, performance optimization, user acceptance, and compliance with code quality standards.</li>
                  <li>Contributed to the Front-End Engineering community by shaping the technical roadmap and defining architecture patterns for the global engineering organization.</li>
                  <li>Mentored junior and mid-level engineers to improve code quality, promote best practices, ensure maintainable code, and enhance test coverage through code reviews.</li>
                </ul>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <ul>
                  <li>Led the development of a dynamic security alert system web portal, customizing D3 libraries to create intuitive and interactive data visualizations for real-time security alerts.</li>
                  <li>Overhauled and incrementally refactored a legacy codebase, modernizing the platform while enhancing functionality and user experience.</li>
                  <li>Innovated and implemented new features to significantly improve website usability and performance.</li>
                  <li>Addressed technical debt by introducing cutting-edge technologies like React Hooks and Styled Components, streamlining development and improving maintainability.</li>
                  <li>Optimized API performance by identifying and resolving query handling bottlenecks in the Django Rest Framework.</li>
                  <li>Conducted thorough code reviews, managed release deployments, and provided mentorship to junior developers, fostering a culture of continuous improvement and technical excellence.</li>
                </ul>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <ul>
                  <li>Spearheaded the development of key e-Commerce website features and online auction functionalities, enhancing user experience and streamlining operations.</li>
                  <li>Led the development team, providing guidance on best coding practices, design patterns, and performance optimization.</li>
                  <li>Conducted root cause analysis and implemented urgent fixes for critical website issues, ensuring minimal downtime and a seamless user experience.</li>
                  <li>Collaborated with direct clients to gather and analyze requirements, translating them into actionable development tasks.</li>
                  <li>Continuously refactored the codebase to improve maintainability, scalability, and performance.</li>
                  <li>Led technical interviews, provided ongoing training, and fostered a culture of knowledge sharing within the team to enhance collective expertise and drive innovation.</li>
                </ul>
                <p>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <ul>
                  <li>Implemented features of a medication dispensing system based on UI mockups, ensuring a seamless user experience.</li>
                  <li>Developed robust RESTful API endpoints to support front-end functionalities.</li>
                  <li>Conducted thorough code reviews with peers, ensuring adherence to best practices for clean, maintainable, and scalable code.</li>
                  <li>Actively participated in code refactoring initiatives to enhance system performance and optimize efficiency.</li>
                  <li>Collaborated closely with test engineers to troubleshoot, identify, and resolve pain points, ensuring high-quality, bug-free releases and continuous system improvement.</li>
                </ul>
                <p>
                  <InlineTitle>Tech Stack</InlineTitle> 
