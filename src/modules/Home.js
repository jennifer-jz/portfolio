    ...
    return (
        ...
        <div className="contactme">
            <p>
                ...
                <a href={`mailto:${contactInfo.email}?Subject=Work Info`} target="_top">
                    {contactInfo.email}
                </a>
            </p>
            <p><a><i className="fa fa-linkedin-square"></i></a><a href={contactInfo.linkedIn} target="_blank">{contactInfo.linkedIn}</a></p>
            <p><a><i className="fa fa-phone-square"></i></a>{contactInfo.phone}</p>
        </div>
        </div>
        </div>
    );
